do
    ...
    Preload = {
        ...
        ability = function(id)
            if preloaderUnit == nil then
                preloaderUnit = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), DUMMY_UNIT_ID, MAP_HIDDEN_X, MAP_HIDDEN_Y, 0.0)
            end

            return UnitAddAbility(preloaderUnit, id) and UnitRemoveAbility(preloaderUnit, id)
        end
